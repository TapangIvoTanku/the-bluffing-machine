...
The formal signaling game literature, pioneered by Spence \citep{Spence1973} and subsequently applied to international relations by Fearon, Morrow, and others, provides a rigorous framework for analyzing this credibility problem \citep{Fearon1994, Morrow1989}. In a signaling game, one player (the Sender) has private information that another player (the Receiver) wants to know. The Sender sends a signal to the Receiver, who then updates their beliefs using Bayes' rule and takes an action. The key insight of the signaling game literature is that not all signals are credible: a signal is credible only if it is costly enough that a low-type Sender would not want to mimic it. This is the logic of ``costly signaling,'' which has been used to explain a wide range of phenomena in international relations, from military mobilization and alliance formation to nuclear posturing and coercive diplomacy. The costly signaling framework provides a powerful explanation for why some signals are believed and others are not, and it generates precise predictions about how rational actors should behave in strategic communication situations. This logic is central to the study of international relations, where scholars have long recognized that perceptions and misperceptions play a crucial role in shaping state behavior \citep{Jervis1976}.

Fearon's (1995) seminal work on rationalist explanations for war is particularly relevant for our purposes \citep{Fearon1995}. Fearon showed that wars can occur between rational actors when two key mechanisms are at play: private information with incentives to misrepresent, and the inability to credibly commit to agreements. The first mechanism, which is the focus of our paper, implies that if states have private information about their resolve or capabilities and an incentive to bluff, they may fail to find a peaceful bargain that both would prefer to war. This framework, further developed by Powell (2008) in the context of nuclear deterrence, suggests that the capacity for strategic deception is not merely a tactical tool but a structural feature of the international system that shapes the probability of conflict \citep{Powell2008, SechserFuhrmann2017}. The credibility of threats is a central theme in this literature, with scholars debating how leaders assess the credibility of threats and what makes some signals more credible than others \citep{Press2005, Sartori2005}. The nuclear taboo, as described by Tannenwald (1999), adds a normative dimension to this strategic logic, suggesting that norms against the use of nuclear weapons can be a powerful constraint on state behavior \citep{Tannenwald1999}. The strategic landscape of the second nuclear age, as analyzed by Bracken (2013) and Narang (2014), is characterized by a more complex and multipolar set of actors, making the problem of credible signaling even more acute \citep{Bracken2013, Narang2014}.
...
The idea of LLMs as strategic agents is a very recent development. Most research on LLMs has focused on their linguistic capabilities---their ability to generate fluent, coherent, and contextually appropriate text---rather than their strategic rationality. A handful of recent papers have begun to explore this area, with mixed findings. Horton (2023) and Aher et al. (2023) have shown that LLMs can simulate human-like behavior in economic games, suggesting some capacity for strategic reasoning \citep{Horton2023, Aher2023}. However, other work has highlighted the limitations of LLM strategic rationality. A systematic survey by Sun et al. (2025) finds that while LLMs can perform well on simple games, they struggle with tasks that require deep recursive reasoning, mixed strategies, and robust belief updating \citep{Sun2025}. The scaling laws for neural language models, as articulated by Kaplan et al. (2020), provide a theoretical framework for understanding why larger models are more capable, but they do not explain the emergence of strategic reasoning capabilities \citep{Kaplan2020}. The technical report for GPT-4, for example, provides extensive detail on the model's capabilities but does not address its strategic rationality \citep{OpenAI2023}. This aligns with our distinction between strategic mimicry and strategic rationality.
